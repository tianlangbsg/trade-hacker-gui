...
# 初始化
from modules.core.utils.stockUtil import get_complete_stock_code
...
def get_all_history(stockCodeList, startDate, endDate):
    ...
    stockCodeListList = stockUtil.list_split(stockCodeList, 50)
    # 遍历所有的list
    for list in stockCodeListList:
        ...
        for data in list:
            ...
            listStr = listStr + stockUtil.format_stock_code_suffix(get_complete_stock_code(data)) + ','
        # 传入参数
